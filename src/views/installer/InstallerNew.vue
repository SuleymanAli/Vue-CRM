<template>
  <div class="installerNew">
    <div class="container-fluid">
      <!-- Installer New: Header -->
      <div class="installerNew__header px-1 px-md-3 py-6 border-bottom row">
        <div class="col-sm-12">
          <h1 class="">
            Add new Installer
          </h1>
